...
const landingImg = require('./assets/landing.png');
const medicalRecordImg = require('./assets/medicalRecord.png');
const schoolImg = require('./assets/school.png');
const bedsImg = require('./assets/beds.png');
const rrtImg = require('./assets/rrt.png');
const keralaImg = require('./assets/kerala.png');
